...
function EditItem()
{
    ...
    const[gettingtype,setgettingtype]=useState("");
    ...
    useEffect(()=>{
        ...
        .then(res=>{
            ...
            if(type=="carproduct")
            {
                ...
                axios.post('http://localhost:3001/getItemsOnID',values)
                .then(res=>{
                    if(res.data.status=='Not')
                        {
                        ...
                        {
                            console.log("retur Data is",res.data.data[0])
                            setName(res.data.data[0].Name);
                            setModel(res.data.data[0].Model);
                            setMadeIn(res.data.data[0].MadeIn);
                            setstartingprice(res.data.data[0].StartingPrice);
                            setbidIncreament(res.data.data[0].bidIncreament);
                            setcondition(res.data.data[0].Conditionn);
                            setfuel(res.data.data[0].Fuel)
                            setmilage(res.data.data[0].Mileage)
                            setdoors(res.data.data[0].Doors)
                            settransmission(res.data.data[0].Transmission);
                            setengine(res.data.data[0].Engine);
                            setcolor(res.data.data[0].Color);
                            setstartingtime(res.data.data[0].StartingTime)
                            setendingtime(res.data.data[0].EndingTime)
                            setstartingprice(res.data.data[0].StartingPrice)
                        }
                })
            }
            else if(type=="house")
            {
                ...
                .then(res=>{
                    if(res.data.status=='Not')
                        ...
                        {
                            console.log("retur Data is",res.data.data[0])
                            setHouseName(res.data.data[0].Housename);
                            setHouseFloors(res.data.data[0].Floors);
                            setHouseStartingPrice(res.data.data[0].startingprice);
                            setHouseStartingTime(res.data.data[0].StartingTime);
                            
                            setHouseEndingTime(res.data.data[0].EndingTime);
                            setHouseBEdrooms(res.data.data[0].bedrooms);
                            setHousePlotsize(res.data.data[0].plotSize);
                            setHouseAddress(res.data.data[0].Address);
                            setHouseCondition(res.data.data[0].conditionn);
                            setHouseBidIncreament(res.data.data[0].BidIncreament);
                ...
                .then(res=>{
                    if(res.data.status=='Not')
                        ...
                        else
                        {
                            ...
                            setJewelryType(res.data.data[0].Type)
                            setJewelryMaterial(res.data.data[0].Material)
                            setJewelryDesigner(res.data.data[0].Designer)
                            setJewelryMadeIn(res.data.data[0].MadeIn)
                            setJewelryBrand(res.data.data[0].Brand)
                            setJewelryStartingPrice(res.data.data[0].StartingPrice)
                            setJewelryStartingTime(res.data.data[0].StartingTime)
                            setJewelryEndingTime(res.data.data[0].EndingTime)
                            setJewelryBidIncreament(res.data.data[0].bidIncreament)
                            setJewelrySize(res.data.data[0].Size)
                            setJewelryCondition(res.data.data[0].Conditionn)
  ...
  const HouseNameInputHandler=(event)=>{
    ...
    const values={
        ...
        engine:engine,
        color:color,
        itemupdateid:gettingId
    }
    const date = new Date(values.startingtime);
    ...
    values.startingtime= `${year}-${month}-${day}T${hours}:${minutes}`;

    const date1 = new Date(values.endingtime);
    
    // Get the date components
    const year1 = date1.getUTCFullYear();
    const month1 = String(date1.getUTCMonth() + 1).padStart(2, '0'); // Months are zero-based
    ...
    // Combine date and time components
    values.endingtime= `${year1}-${month1}-${day1}T${hours1}:${minutes1}`;
    console.log("bas ho ja",values)
    ...
    if(formisvalid)
    {
    axios.post('http://localhost:3001/updatecaritem',formDataToSend,config)
        .then(res=>{
    ...
    const handleHouseSubmit=(event)=>{
        ...
        const date = new Date(values.HouseStartingTime);
        ...
        // Combine date and time components
        values.HouseStartingTime= `${year}-${month}-${day}T${hours}:${minutes}`;
    
        const date1 = new Date(values.HouseEndingTime);
        ...
        // Combine date and time components
        values.HouseEndingTime= `${year1}-${month1}-${day1}T${hours1}:${minutes1}`;
        console.log("bas ho ja",values)
        const formDataToSend = new FormData();
            Object.keys(values).forEach(key => {
                if (key === 'photos') {
        ...
        axios.post('http://localhost:3001/updatehouseitem',formDataToSend,config)
            .then(res=>{
                if(res.data.status=="success")
                {
                navigate('/myitems');
...
const handleJewelrySubmit=(event)=>{
    ...
    const date = new Date(values.JewelryStartingTime);
    ...
    // Combine date and time components
    values.JewelryStartingTime= `${year}-${month}-${day}T${hours}:${minutes}`;

    const date1 = new Date(values.JewelryEndingTime);
    ...
    // Combine date and time components
    values.JewelryEndingTime= `${year1}-${month1}-${day1}T${hours1}:${minutes1}`;
    console.log("bas ho ja",values)
    const formDataToSend = new FormData();
        Object.keys(values).forEach(key => {
            if (key === 'photos') {
    ...
    console.log("form data",formDataToSend)
        ...
        console.log("Helloooooooooooooooo")
    axios.post('http://localhost:3001/updatejewleryitem',formDataToSend,config)
        .then(res=>{
            if(res.data.status=="success")
            {
            navigate('/myitems');
...
{loading && <OverLay></OverLay>}
 ...
 {/* <div class="overlayer" id="overlayer">
    ...
    <div class="hero-section">
        ...
        <div class="bg_img hero-bg bottom_center" style={sectionStyle}></div>
    </div>
    {car&&
            ...
            <div class="account-wrapper mt--100 mt-lg--440">
                <div class="left-side">
                    <div class="section-header" data-aos="zoom-out-down" data-aos-duration="1200">
                        <h2 class="title">Edit Car Item</h2>
                    ...
                    <form class="login-form" onSubmit={handleSubmit} >
                        ...
                        <div class="form-group mb-30">
                            ...
                            <input type="number" min="0" id="car-feul"  value={fuel || 0} onBlur={FuelBlurHandle} onChange={FuelInputHandler} name="startingtime" placeholder="Fuel"/>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <button type="submit"  class="custom-button" >Update Car</button>
                        </div>
                        
                        {ProductAdded && <p color="green">Your Product Added Successfully</p>}
                        {formV && <p color="green">Form is not valid</p>}
                    </form>
                </div>
...
{jewelery&&
               ...
               <div class="container">
                   <div class="account-wrapper mt--100 mt-lg--440">
                       <div class="left-side">
                           <div class="section-header" data-aos="zoom-out-down" data-aos-duration="1200">
                               <h2 class="title">Edit Jewelry Item</h2>
                               <p>We're happy you're here!</p>
                           </div>
                        ...
                        {jewelryTypeIsInValid && <p className="text-danger">{enteredJewelryTypeIsValid}</p>}
                               ...
                               <div class="form-group mb-0">
                                   ...
                                   <button type="submit"  class="custom-button" >Update Jewelry</button>
                               </div>
                               {ProductAdded && <p>Your Product Added Successfully</p>}
                           </form>
                       </div>
                       <div class="right-side cl-white">
                           <div class="section-header mb-0">
    ...
    <section class="account-section padding-bottom">
        <div class="container">
            <div class="account-wrapper mt--100 mt-lg--440">
                <div class="left-side">
                    <div class="section-header" data-aos="zoom-out-down" data-aos-duration="1200">
                        <h2 class="title">Edit House Item</h2>
                        <p>We're happy you're here!</p>
                    </div>
      ...
      {error && <p style={{ color: 'red' }}>{error}</p>}
                        ...
                        <div class="form-group mb-0">
                            ...
                            <button type="submit"  class="custom-button" >Update House</button>
                        </div>
