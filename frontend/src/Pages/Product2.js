    ...
    axios.get('http://localhost:3001/fetchallhouseproduct')
        .then(res=>{
            if(res.data.status=='notsucces')
            {
                ...
                var startdate=res.data.StartingTime;
                ...
                <div className="col-sm-10 col-md-6 col-lg-4">
                    <div className="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1000">
                        <div className="auction-thumb">
                            <NavLink  to={`/productdetails/${item.ID}/house`}><img src={`http://localhost:3001/`+item.picture[0]} alt="car" height="200px" width="200px"/></NavLink>
                            <a href="#" onClick={() =>FvtBids("house",item.ID)} className="rating"><i className={favorites[item.ID] ? "fas fa-star" : "far fa-star"}></i></a>
