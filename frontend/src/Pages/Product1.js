...
{data.map((item) => (
                <div className="col-sm-10 col-md-6 col-lg-4">
                    <div className="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1000">
                        ...
                        <NavLink  to={`/productdetails/${item.ID}/carproduct`}><img src={`http://localhost:3001/`+item.Picture[0]} alt="car" height="200px" width="200px"/></NavLink>
                           <a href="#" onClick={() =>FvtBids("carproduct",item.ID)} className="rating"><i className={favorites[item.ID] ? "fas fa-star" : "far fa-star"}></i></a>
